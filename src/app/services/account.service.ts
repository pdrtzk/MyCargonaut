...
export class AccountService {
  ...
  public async isLoggedIn(): Promise<boolean> {
    ...
    return new Promise<boolean>(async (resolve, reject) => {
      await http.get('https://mycargonaut-backend.herokuapp.com/api/login').toPromise().then((res: any) => {
  ...
  public async login(email: string, password: string): Promise<Cargonaut> {
    ...
    return new Promise<Cargonaut>(async (resolve, reject) => {
      await http.post('https://mycargonaut-backend.herokuapp.com/api/login', {
        email,
        password
  ...
  public async logout(): Promise<void> {
    ...
    return new Promise<void>(async (resolve, reject) => {
      await http.post('https://mycargonaut-backend.herokuapp.com/api/logout', {}).toPromise().then(() => {
        this.userSubject.next(null);
        resolve();
      }).catch(error => {
  ...
  public async register(user: Cargonaut): Promise<void> {
    ...
    return new Promise<void>(async (resolve, reject) => {
      await http.post('https://mycargonaut-backend.herokuapp.com/api/cargonaut', user, {observe: 'response'}).toPromise().then(() => {
        resolve();
      }).catch(error => {
        console.log(`Error: ${error.message} as "${error.error.message}"`);
        reject(error);
  ...
  public async get(userId: number): Promise<Cargonaut> {
    const http = this.http;
    return new Promise<Cargonaut>(async (resolve, reject) => {
      await http.get('https://mycargonaut-backend.herokuapp.com/api/cargonaut/' + userId).toPromise().then((res: any) => {
        resolve(res.user);
      }).catch(error => {
        console.log('Error: ' + error.message);
        reject(error);
  ...
  public async update(user: Cargonaut): Promise<void> { // TODO: check if logged in user is updates user
    ...
    return new Promise<void>(async (resolve, reject) => {
      if (this.user.id === user.id) {
        await http.put('https://mycargonaut-backend.herokuapp.com/api/cargonaut/' + user.id, user).toPromise().then((res: any) => {
          this.isLoggedIn();
          resolve();
        }).catch(error => {
          console.log('Error: ' + error.message);
  ...
  public async delete(user: Cargonaut): Promise<void> {
    ...
    return new Promise<void>(async (resolve, reject) => {
      if (this.user.id === user.id) {
        await http.delete('https://mycargonaut-backend.herokuapp.com/api/cargonaut/' + user.id).toPromise().then((res: any) => {
          this.isLoggedIn();
  ...
  public async updatePassword(user: Cargonaut, password: string): Promise<void> {
    ...
    return new Promise<void>(async (resolve, reject) => {
      if (this.user.id === user.id) {
        await http.put('https://mycargonaut-backend.herokuapp.com/api/password/' + user.id, {password}).toPromise().then((res: any) => {
          // this.isLoggedIn();
          console.log(res.message);
          resolve();
        }).catch(error => {
  ...
  public uploadImage(image: File, user: Cargonaut): Promise<void> {
    ...
    return new Promise<void>(async (resolve, reject) => {
      if (this.user.id === user.id) {
        ...
        await this.http.post(`https://mycargonaut-backend.herokuapp.com/api/cargonaut/${user.id}/upload`, formData).toPromise().then((res: any) => {
            resolve();
          }
        ).catch(error => {
          console.log('Error: ' + error.message);
  ...
  public getImage(userId: number): Promise<string | ArrayBuffer> {
    ...
    return new Promise<string | ArrayBuffer>(async (resolve, reject) => {
      console.log('going to post to upload route');
      await this.http.get(`https://mycargonaut-backend.herokuapp.com/api/cargonaut/${userId}/image`, {
        responseType: 'blob',
        observe: 'response'
